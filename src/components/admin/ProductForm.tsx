...
const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const handleVariantChange = (
    ...
    value: string | number | string[] | ISpecItem[],
  ) => {
  ...
  const inputClass =
    "w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-button2 focus:border-button2 transition-all outline-none bg-white text-gray-800 placeholder-gray-400";
