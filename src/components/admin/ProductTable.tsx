              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                    ...
                    <span
                      className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${isHidden ? "bg-red-100 text-red-800" : "bg-green-100 text-green-800"}`}
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full mr-1 ${isHidden ? "bg-red-500" : "bg-green-500"}`}
                      ></span>
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {products.map((product, index) => {
              ...
              const price = representativeVariant?.price || 0;
              const isHidden =
                product.isHide === Contacts.Status.Evaluation.HIDE;
                ...
                >
                  <td className="p-5">
                    <div className="flex items-center gap-4">
                      ...
                      <span
                        className="font-semibold text-gray-800 line-clamp-1 max-w-50"
                        title={product.title}
                      >
                        {product.title}
                      </span>
                  ...
                  <td className="p-5">
                    ...
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full mr-1.5 ${isHidden ? "bg-red-500" : "bg-green-500"}`}
                      ></span>
                      {isHidden ? "Hidden" : "Public"}
                    </span>
                  </td>
