          ...
          coupons.map((c, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                >
                  <span
                    className={`w-1.5 h-1.5 rounded-full mr-1.5 ${c.isActive ? "bg-green-500" : "bg-gray-400"}`}
                  />
              ...
              <div className="flex flex-wrap gap-2 items-center">
                ...
                <span className="text-xs text-gray-500">
                  Usage: {c.usedCount}/{c.maxUsage === 0 ? "∞" : c.maxUsage}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-0.5 text-xs text-gray-500">
                {c.minOrderValue > 0 && (
                  <span>Min: {c.minOrderValue.toLocaleString()}đ</span>
                )}
                {c.maxDiscount > 0 && (
                  <span>Cap: {c.maxDiscount.toLocaleString()}đ</span>
                )}
                <span>
                  Expires: {new Date(c.expiredAt).toLocaleDateString("vi-VN")}
                </span>
              </div>
