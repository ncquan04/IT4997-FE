  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-4">
        <label className="text-sm font-medium text-gray-600">Filter by tier:</label>
        <select
          value={tierFilter}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                ...
                <th className="px-6 py-3 text-right font-semibold text-gray-600">Points</th>
                <th className="px-6 py-3 text-right font-semibold text-gray-600">Total Spend</th>
                <th className="px-6 py-3 text-right font-semibold text-gray-600">Current Window Spend</th>
              </tr>
            </thead>
            <tbody>
              {members.length === 0 ? (
                ...
                members.map((m: IAdminMember) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-3">
                      <span className={`px-2 py-0.5 rounded-full text-xs font-semibold ${TIER_COLORS[m.memberTier]}`}>
